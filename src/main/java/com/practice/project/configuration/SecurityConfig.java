...
import com.practice.project.service.authentication.UserInfoService;
...
//        configuration.setAllowCredentials(true);
        source.registerCorsConfiguration(STR."\{authenticationProperties.getPathPrefix()}**", configuration);
    ...
    public JwtEncoder jwtEncoder() throws KeyLengthException {
        MACSigner macSigner = new MACSigner(authenticationProperties.getSecretKey());
